  ...
  if (!user) {
    return (
      <div className="flex flex-col items-center justify-center h-[60vh] text-center px-6">
        ...
        <p className="text-[14px] mb-6" style={{ color: 'var(--am-text-2)' }}>Sign in to create and manage playlists</p>
      ...
      <div className="py-8">
        ...
        <div className="px-5 lg:px-8 mb-8 flex flex-col sm:flex-row items-start sm:items-end gap-6">
          ...
          <div>
            ...
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight mb-2">{selectedPlaylist.name}</h1>
            {selectedPlaylist.description && (
              <p className="text-[14px] mb-2" style={{ color: 'var(--am-text-2)' }}>{selectedPlaylist.description}</p>
            )}
        ...
        {playlistSongs.length > 0 ? (
          ...
          <p className="text-center py-10 text-[14px]" style={{ color: 'var(--am-text-2)' }}>This playlist is empty</p>
        )}
      </div>
    )
  }
  ...
  return (
    <div className="py-8">
      <div className="flex items-center justify-between mb-8 px-5 lg:px-8">
        <h1 className="text-[32px] font-bold tracking-tight">Library</h1>
        <button
      ...
      {showCreate && (
        <div className="mx-5 lg:mx-8 mb-6 rounded-2xl p-5 max-w-sm"
          ...
          <h2 className="text-[17px] font-bold mb-4">New Playlist</h2>
          <input
            type="text"
            value={newName}
      ...
      {playlists.length === 0 && !showCreate && (
        <div className="text-center py-20">
          ...
          <p className="text-[14px]" style={{ color: 'var(--am-text-2)' }}>Create your first playlist to get started</p>
        </div>
      )}
